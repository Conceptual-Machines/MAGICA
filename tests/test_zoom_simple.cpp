...
public:
    ...
    void setZoom(double newZoom) {
        ...
        if (onZoomChanged) onZoomChanged(currentZoom);
    }
    ...
    void setZoomCentered(double newZoom, double timePosition) {
        ...
        int newPixelPosition = static_cast<int>(timePosition * currentZoom * viewportWidth / timelineLength);
    ...
    void setTimelineLength(double lengthInSeconds) {
        ...
        if (onContentSizeChanged) onContentSizeChanged(calculateContentWidth());
    }
    ...
    void setCurrentScrollPosition(int scrollX) {
        ...
        if (onScrollChanged) onScrollChanged(currentScrollX);
    }
