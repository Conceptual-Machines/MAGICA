...
public:
    ...
    ResizeHandle(Direction dir) : direction(dir) {
        setMouseCursor(direction == Horizontal ? 
...
void MainWindow::setupMenuBar() {
    ...
    menuBar = std::make_unique<juce::MenuBarComponent>(MenuManager::getInstance().getMenuBarModel());
...
void MainWindow::setupMenuCallbacks() {
    ...
    callbacks.onToggleFullscreen = [this]() {
    ...
    callbacks.onBringAllToFront = [this]() {
        toFront(true);
    };
