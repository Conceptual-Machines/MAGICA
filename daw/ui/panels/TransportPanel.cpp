...
void TransportPanel::setupTransportButtons() {
    // Play button
    playButton = std::make_unique<SvgButton>("Play", BinaryData::play_svg, BinaryData::play_svgSize);
    ...
    // Stop button
    stopButton = std::make_unique<SvgButton>("Stop", BinaryData::stop_svg, BinaryData::stop_svgSize);
    ...
    // Record button
    recordButton = std::make_unique<SvgButton>("Record", BinaryData::record_svg, BinaryData::record_svgSize);
    ...
    // Pause button
    pauseButton = std::make_unique<SvgButton>("Pause", BinaryData::pause_svg, BinaryData::pause_svgSize);
    ...
    // Loop button
    loopButton = std::make_unique<SvgButton>("Loop", BinaryData::loop_svg, BinaryData::loop_svgSize);
...
void TransportPanel::setupTimeDisplay() {
    ...
    timeDisplay->setColour(juce::Label::backgroundColourId, DarkTheme::getColour(DarkTheme::SURFACE));
    ...
    positionDisplay->setColour(juce::Label::backgroundColourId, DarkTheme::getColour(DarkTheme::SURFACE));
...
void TransportPanel::setupTempoAndQuantize() {
    ...
    // Metronome button
    metronomeButton = std::make_unique<SvgButton>("Metronome", BinaryData::volume_up_svg, BinaryData::volume_up_svgSize);
    ...
    // Click button
    clickButton = std::make_unique<SvgButton>("Click", BinaryData::volume_up_svg, BinaryData::volume_up_svgSize);
