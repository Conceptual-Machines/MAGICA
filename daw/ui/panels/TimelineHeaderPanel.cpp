...
void TimelineHeaderPanel::paint(juce::Graphics& g) {
    ...
    g.drawText("TIMELINE", leftPanelWidth + 8, 0, rightDivider - leftPanelWidth - 16, getHeight(), juce::Justification::centredLeft);
    
    // Right section label
    g.drawText("MIXER", rightDivider + 8, 0, rightPanelWidth - 16, getHeight(), juce::Justification::centredLeft);
}
...
void TimelineHeaderPanel::resized() {
    ...
    auto centerBounds = juce::Rectangle<int>(leftDivider, 0, rightDivider - leftDivider, getHeight());
