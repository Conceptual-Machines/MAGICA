...
class DAWModeInterfaceImpl : public DAWModeInterface {
  public:
    ...
    bool isArrangementMode() const override {
        return currentViewMode_ == ViewMode::Arrangement;
    }
    bool isPerformanceMode() const override {
        return currentViewMode_ == ViewMode::Performance;
    }

    // === Audio Mode Implementation ===
    void setAudioMode(AudioMode mode) override;
    AudioMode getAudioMode() const override {
        return currentAudioMode_;
    }
    bool isLiveMode() const override {
        return currentAudioMode_ == AudioMode::Live;
    }
    bool isStudioMode() const override {
        return currentAudioMode_ == AudioMode::Studio;
    }
